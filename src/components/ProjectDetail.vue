    ...
    <v-card-item>
      ...
      <v-card-text>
        <v-row>
          ...
          <v-col :cols="6">
            <v-carousel
              v-if="(props.project.images?.length ?? 0) > 0" height="100%" :show-arrows="false"
              :interval="3000">
              <v-carousel-item
        ...
        <v-row>
          ...
          <v-col :cols="3">
            ...
            <v-row>
              <b class="key">{{ $t("quantity_reclaimed") }}:</b> {{ props.project.quantity_reclaimed }} ({{
                props.project.quantity_reclaimed_unit }})
            </v-row>
