...
async function downloadBundle(filteredDataArray: Project[], currentLocale: string = 'en', isFiltered: boolean = true) {
  try {
    const zip = new JSZip()
    ...
    const predefinedColumnOrder = [
      '_id', 'description_en', 'description_fr', 'name_en', 'name_fr',
      'main_concrete_type', 'main_concrete_type_uncertainty', 'receiver_country',
      'receiver_city', 'location_uncertainty', 'distance_km',
      'distance_smaller', 'start_date_year', 'date_uncertainty',
      'component_age', 'age_smaller', 'age_uncertainty', 'quantity_reclaimed',
      'quantity_reclaimed_unit', 'donor_nb_floor', 'donor_nb_floor_smaller',
      'donor_use', 'donor_element_type', 'receiver_nb_floor', 'receiver_nb_floor_smaller',
      'receiver_nb_floor_larger', 'receiver_nb_floor_uncertainty', 'receiver_use',
      'receiver_element_type', 'element_type_different', 'reference',
      'impact_design_alternative', 'impact_difference', 'impact_source',
      'cost_design_alternative', 'cost_difference_min_percent', 'cost_difference_max_percent',
      'cost_source', 'actors',
      'research_project', 'unbuilt_with_permission'
    ]
